      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-6 md:gap-12 items-center relative z-10">
        ...
        >
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-2xl md:text-5xl font-bold text-center md:text-left"
          >
            About{' '}
        ...
        >
          ...
          >
            <motion.h3 
              ...
              viewport={{ once: true }}
              className="text-lg md:text-xl font-semibold mb-3 md:mb-4 bg-gradient-to-r from-[#a855f7] via-[#d946ef] to-[#ec4899] bg-clip-text text-transparent text-center md:text-left"
            >
              Developer Mindset
            </motion.h3>
            ...
            <ul className="space-y-2 md:space-y-3 text-gray-300 text-xs md:text-sm">
              {['Clean & reusable code', 'Focus on UI/UX design', 'Always learning new tech', 'Problem solving mindset'].map((item, i) => (
                ...
                >
                  <motion.span 
                    className="text-[#d946ef] inline-block text-sm"
